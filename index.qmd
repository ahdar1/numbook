...
## Weekly Exercises and Test on Moodle {.unnumbered}

At the end of your journey (see flowchart), you must attempt the weekly exercises on Moodle. Direct links to the weekly exercises are given at the end of each page or alternatively you can log on Moodle and visit the course page. Once you submit all your answers, you have completed the weekly topic.

![Weekly Exercises On Moodle](images/moodle_exercises.png){#fig-modex fig-align="center" width="25%"}
