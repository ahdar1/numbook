...
\hypersetup{
  pdftitle={Solutions to weekly problems and exercises: Week 8a},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Solutions to weekly problems and exercises: Week 8a}
\author{}
\date{}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, interior hidden, enhanced, sharp corners, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=0.6\textwidth,height=\textheight]{images/businesscosts.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{images/totalcost.png}
