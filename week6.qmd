...
Significant figures of a number relates to how we want to express the accuracy of the number. To decide how many significant figures we want to report, we count at the first non-zero digit. All the zeros **after the decimal point** that are on the right of the last non-zero digit are considered to be significant. For example, 0.05670 contains four significant digits.

![0.05670 contains four significant figures](images/sif1.png){#fig-lvdiagram1 width="50%" fig-align="left"}
