...
Decimal means a number based on 10. The word comes from Latin decima: a tenth part. 56.8 has 5 tens, 6 ones and 8 tenths. The dot is a decimal point. 

::: callout-warning

In the UK system, the decimal point is denoted by a `dot`. In many countries, the decimal point is denoted by a comma!
...
![0.05670 contains four significant figures](images/sif1.png){#fig-sif1 width="50%" fig-align="left"}

![8150 contains four significant figures](images/sif2.png){#fig-sif2 width="50%" fig-align="left"}
